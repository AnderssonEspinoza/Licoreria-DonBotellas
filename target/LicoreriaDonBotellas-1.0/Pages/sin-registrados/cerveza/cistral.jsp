		...
		<div class="productos">
			...
			<div>
				<section class="products-list grid text-center">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="6">
						<img src="cristal_img/Cristal_botella.webp" class="card-img-top" alt="...">
						<div class="card-body">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="5">
						<img src="cristal_img/cerveza-cristal-lata-x-355-ml.jpg" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Cristal Lata</p>
								<p>473ml</p>
								<p>S/5</p>
							</div>
							<a href="#">AÑADIR</a>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="36">
						<img src="cristal_img/Cristal-botella-Six-pack.png" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Cristal</p>
								<p>Pack</p>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="30">
						<img src="cristal_img/Cristal-Lata-355-ml-Six-pack.png" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Cristal Lata</p>
								<p>Pack</p>
