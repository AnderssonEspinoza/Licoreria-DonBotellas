				...
				<div class="col">
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar"
						...
						<ul class="list-group" style="list-style: none">
							<h5>Cervezas</h5>
							<li>
                                                            <a class="palabra-color" href="cistral.jsp">Cristal</a>
							</li>
							<li>
		...
		<section class="products-list grid text-center">
			...
			<div class="card product-item" data-precio="44">
				<section class="card-img-top">
                                    <img src="../../../assets/img/cerveza/cristal_img/Cristal_botella.webp"
						alt="...">
				</section>
				<section class="card-body">
					...
					<div class="card-inferior">
						<button class="btn btn-primary add-to-cart" data-producto-id="400"
