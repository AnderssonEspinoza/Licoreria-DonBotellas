				...
				<div class="col">
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar"
						...
						<ul class="list-group">
							<h5>Pages</h5>
							<li>
                                                            <a class="palabra-color" href="cigarros_electricos.jsp">Cigarro Electrico</a>
							</li>
							<li>
                                                            <a href="cigarros_regulare.jsp">Cigarro Normal</a>
							</li>
							<li>
                                                            <a href="complementos.jsp">Complemento</a>
							</li>
						</ul>
					</div>
				</div>
		...
		<section class="products-list grid text-center">
			<div class="card product-item" data-precio="44">
				<section class="card-img-top">
					<img src="../../../assets/img/cigarros/cigarros_electricos/cigarroElectrico.jpeg"
						alt="...">
				</section>
				<section class="card-body">
					<div class="card-text">
						<p>Cigarro Electrico 1und</p>
						<p>S/28.90</p>
					</div>
					<div class="card-inferior">
						<button class="btn add-to-cart" data-producto-id="501"
							data-producto-name="Cigarro Electrico 1und" data-producto-price="28.90"
							data-producto-image="../../../assets/img/cigarros/cigarros_electricos/cigarroElectrico.jpeg">AÑADIR</button>
					</div>
				</section>
			</div>
			<div class="card product-item" data-precio="44">
