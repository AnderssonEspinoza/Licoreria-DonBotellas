				...
				<div class="col">
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar"
						...
						<ul class="list-group">
							...
							<li>
                                                            <a class="palabra-color" href="energizante.jsp">Energizante</a>
							</li>
							<li>
		...
		<section class="products-list grid text-center">
			<div class="card product-item" data-precio="44">
				<section class="card-img-top">
                                    <img src="../../../assets/img/bebidas_no_alcoholicas/energizante_img/red bull.webp" alt="...">
				</section>
				<section class="card-body">
					...
					<div class="card-inferior">
						<button class="btn add-to-cart" data-producto-id="303"
							data-producto-name="Red Bull" data-producto-price="9.90"
							data-producto-image="../../../assets/img/bebidas_no_alcoholicas/energizante_img/red bull.webp">AÑADIR</button>
					</div>
				</section>
			</div>
			<div class="card product-item" data-precio="44">
