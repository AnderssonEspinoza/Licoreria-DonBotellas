		...
		<div class="productos">
			...
			<div>
				<section class="products-list grid text-center">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="2.50">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="8.50">
						<img src="/img/riccadonnaRuby.jpg" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Cielo Bidon</p>
								<p>7Lt</p>
								<p>S/8.50</p>
							</div>
							<a href="#">AÑADIR</a>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="3.50">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="1">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="2">
						<img src="/img/SIX-PACK-RICCADONNA-ASTI.png" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">San Mateo</p>
