				...
				<div class="col">
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar"
						...
						<ul class="list-group">
							...
							<li>
                                                            <a class="palabra-color" href="cigarros_regulare.jsp">Cigarro Normal</a>
							</li>
							<li>
		...
		<section class="products-list grid text-center">
			<div class="card product-item" data-precio="44">
				<section class="card-img-top">
                                    <img src="../../../assets/img/cigarros/cigarros_regulares/marlboro.jpeg"
						alt="...">
				</section>
				<section class="card-body">
					<div class="card-text">
						<p>Cigarro Marlboro</p>
						<p>S/8.90</p>
					</div>
					<div class="card-inferior">
						<button class="btn add-to-cart" data-producto-id="502"
							data-producto-name="Cigarro Marlboro" data-producto-price="8.90"
							data-producto-image="../../../assets/img/cigarros/cigarros_regulares/marlboro.jpeg">AÑADIR</button>
					</div>
				</section>
			</div>
			<div class="card product-item" data-precio="44">
