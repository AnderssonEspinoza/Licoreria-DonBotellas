				...
				<div class="col">
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar"
						...
						<ul class="list-group">
							...
							<li>
                                                            <a class="palabra-color" href="mikes.jsp">Mikes</a>
							</li>
							<li>
		...
		<section class="products-list grid text-center">
			<div class="card product-item" data-precio="44">
				<section class="card-img-top">
                                    <img src="../../../assets/img/listo_para_tomar/mike_img/mikes.webp" alt="...">
				</section>
				<section class="card-body">
					...
					<div class="card-inferior">
						<button class="btn add-to-cart" data-producto-id="602"
							data-producto-name="Mikes lata" data-producto-price="9.90"
							data-producto-image="../../../assets/img/listo_para_tomar/mike_img/mikes.webp">AÑADIR</button>
					</div>
				</section>
			</div>
			<div class="card product-item" data-precio="44">
