			...
			<div>
				<section class="products-list grid text-center">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="5.50">
						<img src="heineken_img/heineken-botella.png" class="card-img-top" alt="...">
						<div class="card-body">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="33">
						<img src="heineken_img/heineken-botella-pack.webp" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Heineken</p>
								<p>Pack</p>
