		...
		<div class="productos">
			...
			<div>
				<section class="products-list grid text-center">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="6.50">
						<img src="pilsen_img/pilsen-630ML.jpg" class="card-img-top" alt="...">
						<div class="card-body">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="5.50">
						<img src="pilsen_img/Pilsen-Lata.jpg" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Pilsen Lata</p>
								<p>473ml</p>
								<p>S/5.50</p>
							</div>
							<a href="#">AÑADIR</a>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="6.50">
						<img src="pilsen_img/Pilsen-355-ml-Six-pack.png" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Pilsen</p>
								<p>Pack</p>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="5.50">
						<img src="pilsen_img/Pilsen-Lata-355-ml-Six-pack.png" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Pilsen Lata</p>
								<p>Pack</p>
