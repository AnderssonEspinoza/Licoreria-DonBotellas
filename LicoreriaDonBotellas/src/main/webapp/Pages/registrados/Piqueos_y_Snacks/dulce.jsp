		...
		<div class="productos">
			...
			<div>
				<section class="products-list grid text-center">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="1.5">
						<img src="/img/riccadonnaAsti.jpg" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Trident Mora</p>
								<p>Normal</p>
								<p>S/1.50</p>
							</div>
							<a href="#">AÑADIR</a>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="0.20">
						<img src="/img/riccadonnaAsti.jpg" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Chiclets</p>
