				...
				<div class="col">
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar"
						...
						<ul class="list-group">
							...
							<li>
                                                            <a class="palabra-color" href="piscano.jsp">Piscano</a>
							</li>
							<li>
                                                            <a href="smirnoff.jsp">Smimoff</a>
							</li>
							<li>
		...
		<section class="products-list grid text-center">
			<div class="card product-item" data-precio="44">
				<section class="card-img-top">
                                    <img src="../../../assets/img/listo_para_tomar/piscano_img/chilcano-maracuya-1.png" alt="...">
				</section>
				<section class="card-body">
					...
					<div class="card-inferior">
						<button class="btn add-to-cart" data-producto-id="603"
							data-producto-name="Piscano botella" data-producto-price="9.90"
							data-producto-image="../../../assets/img/listo_para_tomar/piscano_img/chilcano-maracuya-1.png">AÑADIR</button>
					</div>
				</section>
			</div>
			<div class="card product-item" data-precio="44">
