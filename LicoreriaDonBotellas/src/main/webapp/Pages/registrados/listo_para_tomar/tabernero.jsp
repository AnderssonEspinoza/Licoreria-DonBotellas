				...
				<div class="col">
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar"
						...
						<ul class="list-group">
							...
							<li>
                                                            <a class="palabra-color" href="tabernero.jsp">Tabernero</a>
							</li>
						</ul>
					</div>
				</div>
		...
		<section class="products-list grid text-center">
			<div class="card product-item" data-precio="44">
				<section class="card-img-top">
                                    <img src="../../../assets/img/listo_para_tomar/tabernero_img/chilcano.webp" alt="...">
				</section>
				<section class="card-body">
					...
					<div class="card-inferior">
						<button class="btn add-to-cart" data-producto-id="605"
							data-producto-name="Four loko" data-producto-price="9.90"
							data-producto-image="../../../assets/img/listo_para_tomar/tabernero_img/chilcano.webp">AÑADIR</button>
					</div>
				</section>
			</div>
			<div class="card product-item" data-precio="44">
