			...
			<div class="container-fluid">
				...
				<div class="image-container col">
					<div class="grid text-center" style="row-gap: 0;">
						<div> <a href="../../generales/index-registrados.jsp">
								<img src="../../../assets/img/logos/logo-superior.png" class="logo-superior"
									id="imagen-ocultar">
							</a>
						</div>
						<div>
							<a href="../../generales/index-registrados.jsp">
								<img src="../../../assets/img/logos/logo-inferior.png" class="logo-inferior">
							</a>
						</div>
				...
				<section class="offcanvas offcanvas-end pt-5 pt-lg-0" id="menuLateral" tabindex="-1">
					...
					<ul class="navbar-nav justify-content mx-auto mb-2  mb-lg-0">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item"
										href="../../../Pages/registrados/Piqueos_y_Snacks/papa.html">Papas</a>
								</li>
								<li><a class="dropdown-item"
	...
	<div class="cuerpo">
		...
		<section class="products-list grid text-center">
			...
			<div class="card product-item" data-precio="50">
				<selection class="card-img-top">
					<img src="../../../assets/img/bebidas_alcoholicas/espumante_img/riccadonnaProsecco.jpg"
