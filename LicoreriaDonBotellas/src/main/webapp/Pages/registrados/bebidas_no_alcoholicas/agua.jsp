				...
				<div class="col">
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasDarkNavbar"
						...
						<ul class="list-group">
							...
							<li>
                                                            <a class="palabra-color" href="agua.jsp">Agua</a>
							</li>
							<li>
		...
		<section class="products-list grid text-center">
			<div class="card product-item" data-precio="44">
				<section class="card-img-top">
                                    <img src="../../../assets/img/bebidas_no_alcoholicas/agua_img/agua cielo.jpeg" alt="...">
				</section>
				<section class="card-body">
					...
					<div class="card-inferior">
						<button class="btn add-to-cart" data-producto-id="302"
							data-producto-name="Agua Cielo" data-producto-price="1.00"
							data-producto-image="../../../assets/img/bebidas_no_alcoholicas/agua_img/agua cielo.jpeg">AÑADIR</button>
					</div>
				</section>
			</div>
			<div class="card product-item" data-precio="44">
