<%-- 
    Document   : index
    Created on : 18 sep 2024, 10:34:10â€¯a.m.
    Author     : vegac
--%>
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      <symbol id="search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        <title>Search</title>
        <path fill="#FFFFFF" d="M19 3C13.488 3 9 7.488 9 13c0 2.395.84 4.59 2.25 6.313L3.281 27.28l1.439 1.44l7.968-7.969A9.922 9.922 0 0 0 19 23c5.512 0 10-4.488 10-10S24.512 3 19 3zm0 2c4.43 0 8 3.57 8 8s-3.57 8-8 8s-8-3.57-8-8s3.57-8 8-8z" />
    </symbol>
              ...
              <div class="row d-flex align-items-center">
                ...
                <div class="col-md-5">
                  <div class="image-holder">
                    <img src="images/banner-image.png"  style="opacity: 0.1;" alt="banner">
                  </div>
                </div>
...
<!--Section de informacion de la empresa Don Botellas-->
    ...
    <!--Secciton de carrusel de productos Wiskies-->
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="images/blueLabel.webp" alt="product-item" class="img-fluid">
                  </div>
          ...
          <div class="swiper product-watch-swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="images/vino.webp" alt="product-item" class="img-fluid">
                  </div>
                  <div class="cart-concern position-absolute">
                    <div class="cart-button d-flex">
                      <a href="#" class="btn btn-medium btn-black">Añadir al carrito<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
        ...
        <div class="row">
          ...
          <div class="post-grid d-flex flex-wrap justify-content-between">
            <div class="col-lg-4 col-sm-12">
              ...
              <div class="card border-none me-3">
                ...
                <div class="card-image">
                  <img src="images/img-notice-one.webp" alt="" class="img-fluid">
                </div>
              </div>
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="images/img-notice-two.webp" alt="" class="img-fluid">
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="images/img-notice-thre.webp" alt="" class="img-fluid">
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
            ...
            <div class="col-md-5 col-sm-12">
              <form class="subscription-form validate">
                <div class="input-group flex-wrap">
                  ...
                  <button class="btn btn-medium btn-primary text-uppercase btn-rounded-none" type="submit" name="subscribe">Subscribirse</button>
                </div>
              </form>
            </div>
          </div>
