			...
			<div>
				<section class="products-list grid text-center">
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="7">
						<img src="cusqueña_img/cusqueña_negra.png" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Cusqueña Negra</p>
								<p>630ml</p>
								<p>S/7</p>
							</div>
							<a href="#">AÑADIR</a>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="4.50">
						<img src="cusqueña_img/cusqueña_mini_negra.jpg" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Cusqueña mini Negra</p>
								<p>310ml</p>
								<p>S/4.50</p>
							</div>
							<a href="#">AÑADIR</a>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="7">
						<img src="cusqueña_img/cusquena-trigo.jpg" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Cusqueña Trigo</p>
								<p>630ml</p>
								<p>S/7</p>
							</div>
							<a href="#">AÑADIR</a>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="4.50">
						<img src="cusqueña_img/cusqueña_mini_trigo.png" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Cusqueña mini Trigo</p>
								<p>310ml</p>
								<p>S/4.50</p>
							</div>
							<a href="#">AÑADIR</a>
					...
					<div class="card product-item g-col-3" style="width: 11rem;" data-precio="4.50">
						<img src="cusqueña_img/Cusquena-de-Trigo-Lata-355-ml.png" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="separacion">
								<p href="#">Cusqueña Lata</p>
								<p>355ml</p>
								<p>S/4.50</p>
							</div>
							<a href="#">AÑADIR</a>
